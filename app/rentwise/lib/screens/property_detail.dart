...
class PropertyDetail extends StatefulWidget {
  final snap;
  const PropertyDetail({super.key, required this.snap});
...
class _PropertyDetailState extends State<PropertyDetail> {
  ...
  void initState() {
    super.initState();
    // _futureRoom = PropertyMethods().getPropertyDetails(pId: widget.snap.pId);
  ...
  Future<List<model.Room>?> reload() async {
    _futureRoom = PropertyMethods().getPropertyDetails(pId: widget.snap.pId);
    _futureRoom?.then((value) {
      _roomCounter = value.length;
      //print(_roomCounter);
        ...
        child: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                Navigator.of(context).
                  push(MaterialPageRoute(builder: (context) => PropertySet(snap: widget.snap)));
              }, 
            ...
            IconButton(
              onPressed: () {
                Navigator.of(context).
                  push(MaterialPageRoute(builder: (context) => RoomSet(pId: widget.snap.pId)));
              }, 
